...
class SetupWizard {
  ...
  public static function setup(Event $event): bool {
    ...
    $params = [
      'project_profile' => 'pece-project',
      'project_id' => 'drupal-pece',
      'project_name' => 'PECE',
      'project_vendor' => 'pece-project',
      'project_description' => 'Drupal 9 template for websites.',
      'project_email' => 'PECE Mailbox'
    ];
