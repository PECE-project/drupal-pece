...
var ArtifactVideoPage = function() {
  ...
  var formId = '#pece-artifact-tabular-node-form ';
  ...
  this.publishButton = $('#pece-artifact-tabular-node-form #edit-submit');

  // Define video pageobject methods.
  this.get = function() {
    browser.get('node/add/pece-artifact-tabular');
  };
  ...
  this.checkFileFormat = function() {
    ...
    expect(fileFormats.getText()).toContain('txt csv xls xlsx ods xml json rdf zip');
  };
