...
class Node extends D7Node {
  ...
  public function prepareRow(Row $row) {
    ...
    if ($permission == self::PERMISSION_PRIVATE) {
      // Only owner can view
      $permissionByUserView = [
        'target_id' => $row->getSourceProperty('uid'),
        'grant_view' => 1,
        'grant_update' => 1,
        'grant_delete' => 1,
      ];
      ...
      $row->setSourceProperty('permission_by_user_view', $permissionByUserView);
    }
  ...
  public function setPermissionByUser(&$row, $nid) {
    ...
    $permissionByUserView = $query->execute()->fetchCol();
    foreach ($permissionByUserView as $key => $item) {
      $permissionByUserView[$key] = [
        'target_id' => $item,
        'grant_view' => 1,
        'grant_update' => 1,
        'grant_delete' => 0,
