...
namespace Drupal\Tests\pece_artifacts_video\Functional;

use Drupal\Tests\BrowserTestBase;

/**
 * Test create artifact Video.
 *
 * @group pece_artifacts
 * @group pece_artifacts_video
 */
class PeceArtifactVideoTest extends BrowserTestBase {
  ...
  /**
   * Test the create node pece artifact video.
   */
  public function testCreateContent(): void {
    $node = $this->drupalCreateNode([
      'type'  => 'pece_artifact_video',
      'title' => 'Video Artifact 1',
    ]);

    $this->drupalGet('node/' . $node->id());
    $this->assertSession()->statusCodeEquals(200);
    $this->assertSession()->titleEquals('Video Artifact 1 | Drupal');
  }
