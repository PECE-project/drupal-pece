...
namespace Drupal\Tests\pece_artifacts_image\Functional;

use Drupal\Tests\BrowserTestBase;

/**
 * Test create artifact Image.
 *
 * @group pece_artifacts
 * @group pece_artifacts_image
 */
class PeceArtifactImageTest extends BrowserTestBase {
  ...
  /**
   * Test the create node pece artifact image.
   */
  public function testCreateContent(): void {
    $node = $this->drupalCreateNode([
      'type'  => 'pece_artifact_image',
      'title' => 'Image Artifact 1',
    ]);

    $this->drupalGet('node/' . $node->id());
    $this->assertSession()->statusCodeEquals(200);
    $this->assertSession()->titleEquals('Image Artifact 1 | Drupal');
  }
