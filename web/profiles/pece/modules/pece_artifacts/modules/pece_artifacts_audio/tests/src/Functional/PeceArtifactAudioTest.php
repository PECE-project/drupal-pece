...
namespace Drupal\Tests\pece_artifacts_audio\Functional;

use Drupal\Tests\BrowserTestBase;

/**
 * Test create artifact Audio.
 *
 * @group pece_artifacts
 * @group pece_artifacts_audio
 */
class PeceArtifactAudioTest extends BrowserTestBase {
  ...
  /**
   * Test the create node pece artifact audio.
   */
  public function testCreateContent(): void {
    $node = $this->drupalCreateNode([
      'type'  => 'pece_artifact_audio',
      'title' => 'Audio Artifact 1',
    ]);

    $this->drupalGet('node/' . $node->id());
    $this->assertSession()->statusCodeEquals(200);
    $this->assertSession()->titleEquals('Audio Artifact 1 | Drupal');
  }
