...
namespace Drupal\Tests\pece_artifacts_website\Functional;

use Drupal\Tests\BrowserTestBase;

/**
 * Test create artifact Website.
 *
 * @group pece_artifacts
 * @group pece_artifacts_website
 */
class PeceArtifactWebsiteTest extends BrowserTestBase {
  ...
  public function testCreateContent(): void {
    $node = $this->drupalCreateNode([
      ...
      'title' => 'Website Artifact 1',
    ]);

    $this->drupalGet('node/' . $node->id());
    $this->assertSession()->statusCodeEquals(200);
    $this->assertSession()->titleEquals('Website Artifact 1 | Drupal');
  }
