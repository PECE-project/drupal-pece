...
context('Permissions', () => {
  ...
  describe('Default Visibility', () => {
    it ('group with default visibility', () => {
      ...
      cy.updateContent(title, [
        '#edit-og-group-ref-und-0-default:select:' + publicGroup
      ])
    })
  ...
  describe('Private Visibility', () => {
    ...
    it ('add user and researcher in the content group', () => {
      cy.login('admin')
      cy.updateUser('user', [
        '#edit-og-user-node-und-0-default:select:' + publicGroup
      ])
    ...
    it("user in group content can\'t access this content", () => {
      cy.login('user')
      cy.testNoAccess(path)
      cy.testNoAccess(path + '/essay')
    })
