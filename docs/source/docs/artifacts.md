...
<!-- TODO: Screenshots below were captured on PECE 1.x (Drupal 7) and need to be
     replaced with PECE 2.x (Drupal 11) screenshots. Navigation paths and field
     labels may also differ. See https://github.com/PECE-project/drupal-pece/pull/553
...
Click Save.
Next, fill out the "Contribution Metadata" section, making sure to select the correct license and add any critical commentary. For the license, we encourage you to leave it as Attribution, Share Alike CC BY-SA, but you can choose any of the other Creative Commons licenses as you see fit. Descriptions of available Creative Commons licenses can be found <a href="https://creativecommons.org/share-your-work/cclicenses/">here</a>.
...
Tag the content. As you type, suggested tags will be automatically generated if they exist already in the system. We recommend following these suggestions and using existing tags if they are not too different from what you were intending, but feel free to make up new tags!
...
In this field, you should provide commentary on the artifact that documents its significance as an ethnographic object and why it is relevant to the platform.
...
You cannot download files that are listed as All Rights Reserved. Please see the *<a href="https://creativecommons.org/licenses/">Licensing</a>* section for more information about this. Audio files and video files that have been added as part of Open artifacts can be downloaded from the platform. Navigate to the artifact page where the file is displayed. In the bottom right hand corner of the rendered file, there will be an upside down arrow. Click this button to download the file.
...
Currently, you cannot embed a YouTube or Vimeo video in the platform.
