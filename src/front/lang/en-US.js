export default {
  ...
  project_title: 'Platform for Experimental, Collaborative Ethnography',
  project_description: '(<b><abbr title="Platform for Experimental, Collaborative Ethnography">PECE</abbr></b>: pronounced “peace”) Is an open source (Drupal-based) digital platform that supports multi-sited, cross-scale ethnographic and historical research. The platform links researchers in new ways, enables new kinds of analyses and data visualization, and activates researchers’ engagement with public problems and diverse audiences. PECE is at the center of a research project that explores how digital infrastructure can be designed to support collaborative hermeneutics....',
  nav: {
    home: 'Home',
    about: 'About',
  ...
  need_help: 'Need help with PECE',
  invite_slack: 'Join the PECE Slack channel',
  validation: {},
  auth: {},
  password: {},
  a11y: {
