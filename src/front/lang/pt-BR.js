export default {
  ...
  need_help: 'Precisa de ajuda com o PECE',
  invite_slack: 'Participe do canal PECE Slack PECE',
  validation: {},
  auth: {},
  password: {},
  a11y: {
